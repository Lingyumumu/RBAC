...
*/
    ...
    <table border="1" cellspacing='10'>
        <a href="create_salle.php">Ajouter une salle</a>
        <tr>
            <th>Nom de Salle</th>
            <th>Capaciter</th>
        </tr>
        <?php while($row = mysqli_fetch_assoc($results)){
            ...
            echo '<td><a href="edit_salle.php?ID=' . $row['ID'] . '">Modifier</a></td>';
            echo '<td><a href="delete_salle.php?ID=' . $row['ID'] . '">Supprimer</a></td>';
            echo '</tr>';
        }
    ?>
    </table>
