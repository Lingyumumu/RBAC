...
<h1>EFREI - Personnel Administratif</h1>
        <nav>
            <ul>
            <li><a href="../../Administrateur/Home_Personnel.php">Accueil</a></li>
                ...
                <li><a href="../../Administrateur/user/list_register.php">Utilisateurs</a></li>
...
if (mysqli_num_rows($resultCours) > 0) {
    ...
    while ($row = mysqli_fetch_assoc($resultCours)) {
        ...
        if ($formation != $prevFormation) {
            echo "<tr>
                    <td>$formation</td>
                    <td><a href='../notes/list_etudiant_note.php?nom_formation=$formation'>Les cours de la formation</a></td>
                  </tr>";
        }
