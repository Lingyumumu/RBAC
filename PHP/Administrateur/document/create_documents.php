...
if (isset($_POST['btnUpload'])) {
    ...
    $query = "INSERT INTO documents (nom_fichier, type_fichier, taille_fichier, contenu_fichier,ID_expediteur,role_expediteur,ID_cours, date)
     VALUES ('$nomFichier', '$typeFichier', '$tailleFichier', '$contenuFichier','$id','$role','', NOW())";
...
<head>
    <meta charset="UTF-8">
    <title></title>
    <link rel="stylesheet" href="create_documents.css">
</head>
...
<h2>Liste des documents a Admin</h2>
<html>
...
<table border="1" cellspacing='10'>
        ...
        <?php while($row = mysqli_fetch_assoc($resultfilter)){
            ...
            echo '<td>' . $row['taille_fichier'] . ' Mo</td>';
            echo '<td>' . $row['date'] . '</td>';
            echo '</tr>';
        }
    ?>
